...
namespace GHC2.Controllers
{
    ...
    public class DoctorsController : Controller
    {
        ...
        public IActionResult GetPatientProfileWithNewDiagnose(int id)
        {
        ...
        public IActionResult GetPatientProfileReadonly(int id)
        {
       ...
       [HttpPost]
        ...
        public IActionResult GetPatientAnalysesDetailsReadonly(int id)
        {
        ...
        public IActionResult GetPatientRadiationsDetailsReadonly(int id)
        {
